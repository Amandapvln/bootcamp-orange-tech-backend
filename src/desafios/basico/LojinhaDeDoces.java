...
Para aumentar as vendas o dono resolveu colocar uma máquina onde os clientes, principalmente 
as crianças que estão muito acostumadas com a tecnologia, poderiam colocar suas moedas e receber 
...
public class LojinhaDeDoces {
	public static void main(String[] args) {
		...
		int doce = 2;
		int valor = dinheiro * doce;

		System.out.println("O cliente obteve " + valor + " doces");
